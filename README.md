...
## 2022년 4월 29일
### 다이나믹 프로그래밍
- [1003 피보나치 함수](Python/1003_피보나치_함수.py)

## 2022년 3월 2일
### 시뮬레이션
- [14499 주사위 굴리기](Python/14499_주사위_굴리기.py)

## 2022년 2월 3일
### LIS, 이분 탐색
- [2342 반도체 설계](Python/2352_반도체_설계.py)

## 2022년 1월 29일
### LIS, 이분 탐색
- [12012 가장 긴 증가하는 부분수열 2](Python/12012_가장긴증가하는부분수열2.py)
    - 이분 탐색을 정확히 구현하는 것이 중요
    - start, end, mid 어떤 값을 리턴할 것인가

## 2022년 1월 26일
### 이분 탐색
- [2110 공유기 설치](Python/2110_공유기_설치.py)
    - Parametric Search
        - 원하는 조건을 만족하는 가장 알맞은 값을 찾을 때 사용
        - 보통 이분 탐색으로 값의 범위를 좁힘
        - 조건에 만족할 때까지 값을 조정

## 2022년 1월 25일
### 이분 탐색
- [10815 숫자 카드](Python/10815_숫자_카드.py)
    - 데이터가 천만개를 넘거나 탐색 범위가 천억 이상인 경우 이진 탐색을 활용해보자
    - 입력 데이터 시간초과 문제를 해결해야 할 수도 있다
        - `sys.stdin.readline().rstrip()`
### BFS
- [11724 연결 요소의 개수](Python/11724_연결요소의_개수.py)

## 2022년 1월 24일
### BFS
- [2178 미로 탐색](Python/2178_미로_탐색.py)
### DFS
- [1012 유기농 배추](Python/1012_유기농_배추.py)

## 2022년 1월 23일
### DFS
- [2667 단지 번호 붙이기](Python/2667_단지번호붙이기.py)
- [4963 섬의 개수](Python/4963_섬의_개수.py)
    - 최대 재귀 한도 10000 설정

## 2022년 1월 20일
### 재귀
- [2477 별 찍기 10](Python/2477_별_찍기_10.py)

## 2022년 1월 13일
### 시뮬레이션, 구현
- [1966 프린터큐](Python/1966_프린터큐.py)
- [14503 로봇청소기](Python/14503_로봇청소기.py)

## 2022년 1월 10일
### DFS
- [2606 바이러스](Python/2606_바이러스.py)

## 2022년 1월 7일
### 그리디 알고리즘
- [11047 동전](Python/11047_동전_0.py)
- [2217 로프](Python/2217_로프.py)
...
- [11399 ATM](Python/11399_ATM.py)
   - [제출결과](http://boj.kr/bb78d28927b741e795e80c63e41a54e8)

## 2021년 11월 25일
### 퀵정렬
1. [11651 좌표 정렬하기 2](Python/11651_좌표_정렬하기_2.py)
   - [제출결과](http://boj.kr/8490236e2d37473f91592d211a191152)
   - reference type 초기화 주의
